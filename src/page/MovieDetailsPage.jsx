    ...
    return (
        ...
        >
            <div className="relative mt-[140px]">
                {isMobile ? (
                    <MobileMovieInfo data={data} slug={slug}></MobileMovieInfo>
                ) : (
                    <DesktopMovieInfo
                        data={data}
                        slug={slug}
...
function DesktopMovieInfo({ data, slug }) {
    ...
    return (
        <div className="w-full h-[600px] relative">
            ...
            <div className="w-full max-w-[800px] absolute top-[36%] right-16 text-white">
                ...
                <h3 className="mb-5 text-4xl font-extrabold">{title}</h3>
...
function MobileMovieInfo({ data, slug }) {
    const navigate = useNavigate();
    const {
        backdrop_path,
        poster_path,
    ...
    return (
        <div className="w-full h-[1200px] relative">
            ...
            ></div>
            <div className="absolute top-0 z-10 flex flex-col items-center justify-center p-5">
                <h3 className="mb-5 text-4xl font-extrabold text-primary">
                    {title}
                </h3>
                ...
                <div className="w-full h-[450px] relative">
                    ...
                    />
                    <span
                        className="absolute text-white top-[70%] cursor-pointer w-full left-0 bg-primary flex items-center 
                        justify-center px-6 py-3 mt-5 gap-x-3 z-[9999] transition-all"
                        onClick={() => navigate(`/watch/movie/${slug}`)}
                    >
                        <span>Watch now</span>
                        <svg
                ...
                <div className="mt-5 text-xl font-medium leading-relaxed text-gray-300">
                    <p>{overview}</p>
                </div>
                ...
                <div className="flex items-center gap-x-[50px] mt-5 text-gray-300">
                    <div className="flex items-center gap-x-2">
                        <span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
...
function MovieMeta({ type }) {
    const { slug } = useParams();
    const { data, error } = useSWR(tmdbAPI.getMovieMeta(slug, type), fetcher);
            ...
            <div className="py-16">
                ...
                <div className="grid grid-cols-2 gap-5 lg:grid-cols-4">
                    {cast.slice(0, 4).map((item) => (
                        <div key={item.id} className="p-3 cast-item">
                            <img
                    ...
                    <div className="flex flex-col items-center justify-center gap-10">
                        {results.slice(0, 2).map((item) => (
                            <div key={item.id}>
                                ...
                                <div className="aspect-video lg:h-[500px] h-full w-full">
                                    <LoadingIframe
...
DesktopMovieInfo.propTypes,
    (MobileMovieInfo.propTypes = {
